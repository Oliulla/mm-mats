...
export class PointMaterialTransferRepository {
  @Prop({
    type: mongoose.Schema.Types.ObjectId,
    required: true,
    ref: 'Campaign',
  ...
  srcCampaign: mongoose.Schema.Types.ObjectId;

  @Prop({ type: mongoose.Schema.Types.ObjectId, required: true, ref: 'Point' })
  srcPoint: mongoose.Schema.Types.ObjectId;
...
export const PointMaterialTransferRepositorySchema =
  SchemaFactory.createForClass(PointMaterialTransferRepository);
